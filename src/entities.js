...
export const ENEMY_TYPES = {
  ...
  skirmisher: { tex: 'enemy_skirmisher', hp: 50, speed: 78,  rifle: { range: 430, spread: 13, dmg: 50, reload: 3.6 } },
  runner:     { tex: 'enemy_runner',     hp: 45, speed: 160, melee: { dmg: 7,  cd: .6 } },
  marksman:   { tex: 'enemy_marksman',   hp: 55, speed: 74,  rifle: { range: 580, spread: 3,  dmg: 60, reload: 3.4 } },
